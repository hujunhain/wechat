    ...
    <div role="main" class="ui-content">
        ...
        <div class="ui-grid-c">
           <input type="hidden" id="sellerId" value="${seller.id}">
            ...
            <div class="ui-block-c"  style="width: 20%"><div class="ui-bar ui-bar-a" style="height:60px">${seller.deptName}</div></div>
            <div class="ui-block-d"  style="width: 20%"><div class="ui-bar ui-bar-a" style="height:60px">${seller.mobile}</div></div>
            <div class="ui-block-e" style="width: 20%" > <div class="ui-bar ui-bar-a" style="height:60px">
                <select name=“statusId"  id=“statusId"  id="slider-flip-m" data-role="slider" data-mini="true">
