...
public class WxConsts {
  ...
  public static final String EVT_SCAN = "SCAN"; //扫描带参数二维码事件
  ...
  public static final String EVT_SCANCODE_PUSH = "SCANCODE_PUSH" ;//扫码推事件
  public static final String EVT_SCANCODE_WAITMSG = "SCANCODE_WAITMSG" ;///扫码推事件且弹出“消息接收中”提示框
  public static final String EVT_PIC_SYSPHOTO = "PIC_SYSPHOTO" ;//弹出系统拍照发图
  public static final String EVT_PIC_PHOTO_OR_ALBUM = "PIC_PHOTO_OR_ALBUM" ;//弹出拍照或者相册发图
  public static final String EVT_PIC_WEIXIN = "PIC_WEIXIN" ;//弹出微信相册发图器
  public static final String EVT_LOCATION_SELECT = "LOCATION_SELECT" ;//弹出地理位置选择器
